...
//org $c00066		// This is a unique sequence
sta $1d34     
bne $006e     
iny           
lda [$a5],y   
...
//org $c0009e		// This is a unique sequence
lda $0344     
sta $1d28     
lda $0345     
sta $1d2a     
...
//org $c174f8		// This is a unique sequence
rtl           

//org $c00535		// This is a unique sequence
jmp $05a3     
rep #$20      
lda $035d     
sec           
...
ldy $035f     
lda $7e8000,x 
sta $2118      //VMDATAL - (65816)VRAM Data Write Registers (Low)
inx           
dey           
bne $05f9     

//org $c00604		// This is a unique sequence
jmp $0580     

//org $c005e5		// This is a unique sequence
ldy $035f     
lda $7e8000,x 
sta $2119      //VMDATAH - (65816)VRAM Data Write Registers (High)
inx           
dey           
bne $05e8     

//org $c005f3		// This is a unique sequence
jmp $0580     

//org $c219bb		// This is a unique sequence
rts           

//org $c21cec		// This is a unique sequence
jsr $1edc     

//org $c21cef		// This is a unique sequence
bra $1cfe     
beq $1d74     
bra $1d7f     

//org $c14711		// This is a unique sequence
lda [$0d]     
sta $0315     
lda [$0d],y   
sta $0316     
...
//org $c146e9		// This is a unique sequence
lda [$0d]     
sta $0309     
lda [$0d],y   
sta $030a     
...
//org $c14700		// This is a unique sequence
lda [$0d]     
sta $0314     
lda [$0d],y   
sta $0313     
...
//org $c146cc		// This is a unique sequence
lda [$0d]     
sta $0306     
lda [$0d],y   
sta $0307     
...
//org $c13098		// This is a unique sequence
phb           
phy           
phx           
lda [$0d]     
...
//org $c130d6		// This is a unique sequence
phy           
ldy #$00      
lda $b3       
bit #$80      
...
sta $b3       
bit #$80      
beq $3101      //ICR2 - (Super-FX)Instruction cache-8bit-RW
lda #$7f      
jsr $3036      //ROMBR - (Super-FX)ROM bank register-8bit-R
sta [$ae],y   
sta [$a5],y   
iny           
lda $b1       
...
//org $c13106		// This is a unique sequence
lda #$01      
jsr $3027     

//org $c1310b		// This is a unique sequence
lda #$00      
sta [$ae],y   
sta [$a5],y   
ply           
...
//org $c14d37		// This is a unique sequence
and #$7f      

//org $c13138		// This is a unique sequence
plx           
ply           
plb           
rtl           

//org $c14693		// This is a unique sequence
lda [$0d]     
sta $030f     
lda [$0d],y   
sta $0310     
...
//org $80f71b		// This is a unique sequence
lda $03d3     
beq $f76b     
phb           
phy           
...
//org $80f764		// This is a unique sequence
jsl $c0075c   
lda #$01      
sta $0ae9     
rtl           
...
//org $80f3ee		// This is a unique sequence
lda $033e     
sta $0aea     
stz $0ae9     

//org $c2199c		// This is a unique sequence
stz $b1       
rep #$20      
lda [$0d]     
sep #$20      
...
//org $c218d8		// This is a unique sequence
ldx #$00      
bra $18ee     
rep #$20      
lda $c21917,x 
...
//org $c2190e		// This is a unique sequence
lda $9f       
and [$0d]     
jsl $c174d1   

//org $c21916		// This is a unique sequence
rts           

//org $c2198a		// This is a unique sequence
lda $0373     
ora $0374     
bne $199c     

//org $c219a6		// This is a unique sequence
dec $b1       

//org $c218e8		// This is a unique sequence
ldx #$08      
bra $18ee     

//org $c21993		// This is a unique sequence
lda $0373     
ora $0374     
beq $199c     
